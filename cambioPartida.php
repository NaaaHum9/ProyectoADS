...
$consulta="SELECT partida.*, deportivo.nombre FROM partida JOIN deportivo ON partida.idDeportivo = deportivo.idDeportivo where idpartida=".$id;
...
<body>
    ...
    <main>
        <section>
            <div>
                <h3>Cambiando Partida <?php echo $info['nombrePartida']; ?> en <?php echo $depor[1]; ?></h3>
            </div>
            <form action="#" method="post" id="resgistro-usuario">
                <ul>
                    <li>
                        <label for="nombre">Nombre:</label>
                        <input type="text" name="nombre" id="nombre" value=<?php echo '"'.$info['nombrePartida'].'"'; ?>  />
                    </li>
                    <li>
                        <label for="descripcion">Descripción:</label>
                        <input type="text" name="descripcion" id="descripcion" value=<?php echo '"'.$info['descripcionPartida'].'"'; ?>  />
                    </li>
                    <li>
                        <table>
                            <tr>
                    ...
                    <td>
                        ...
                        <input type="date" name="fecha" id="fecha" value=<?php echo '"'.$info['fechaPartida'].'"'; ?> />
                    </td>
                    </tr>
                    </table>
                    </li>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <input type="number" name="duracion" id="duracion" value=<?php echo $info['duracionPartida']; ?> >min.
                                </td>
                                <td>
                                    <label for="hora">Hora de reunión:</label>
                                    <input type="time" name="hora" id="hora" value=<?php echo '"'.$info['horaReunion'].'"'; ?> />
                                </td>
                            </tr>
                        </table>
                    </li>
                    ...
                    <td>
                        ...
                        <input type="text" name="uniforme" id="uniforme" value=<?php echo '"'.$info['uniformes'].'"'; ?> />
                    </td>
                    </tr>
                    </table>
                    </li>
                    <li>
                        ...
                        <input type="text" name="empresa" id="empresa" value=<?php echo '"'.$info['empresaPatrocinioPartida'].'"'; ?> />
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" name="extra" id="extra" value=<?php echo '"'.$info['indicacionesExtra'].'"'; ?> />
                    </li>
                    <li>
                        <div class="div-boton-resgistro">
                            <input type="submit" name="sign" value="Editar Partida">
                        </div>
                    </li>
                </ul>
...
if (isset($_POST["sign"])) {
    ...
    $insertarRegistro = "UPDATE partida SET nombrePartida='".$nombre."',descripcionPartida='".$desc."',lugarPartida='".$lugar."',
    fechaPartida='".$fecha."',duracionPartida=".$duracion.",horaReunion='".$hora."',deportePartida='".$deporte."',uniformes='".$uniforme."',
    empresaPatrocinioPartida='".$empresa."',publicoDirigido='".$publico."',nivelExperiencia='".$experiencia."',indicacionesExtra='".$extra."',idDeportivo=".$idDepor.",idUsuario=".$_SESSION['id'];
