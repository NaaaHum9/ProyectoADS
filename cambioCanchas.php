...
<body>
    ...
    <main>
        <section>
            <h3 id="titulo">Actualizar Cancha en <?php echo $info[1];?></h3>
            <form action="#" method="post" name="alta-espacio">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" name="medida" id="medida" value=<?php echo '"'.$info['medidasCancha'].'"';?> required/>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <textarea name="equip" id="equip" placeholder="Ingresa el equipamiento de la cancha" required><?php echo $info['equipamientoCanchaTipo']?></textarea>
                    </li>

                    <li>
                        <label for="iluminacion">¿Tiene iluminación?</label>
                            <label for="iluminacion-si"><input type="radio" name="iluminacion" value="1" id="ilu-si">Si</label>
                            <label for="iluminacion-no"><input type="radio" name="iluminacion" value="0" id="ilu-no">No</label>
                            <?php
                            if(!empty($info['iluminacionCanchaStatus'])){

                                if($info['iluminacionCanchaStatus']==0){

                                    echo '<script>document.getElementById("ilu-no").checked = true;</script>';

                                }else{
                                    echo '<script>document.getElementById("ilu-si").checked = true;</script>';
                    ...
                    <li>
                        <label for="techo">¿Está techada?</label>
                            ...
                            <?php
                            if(isset($info['techadoCancha'])){
                                if($info['techadoCancha']==0){

                                    echo '<script>document.getElementById("techo-no").checked = true;</script>';

                                }else{
                                    echo '<script>document.getElementById("techo-si").checked = true;</script>';
                    ...
                    <li>
                        <label for="mascotas">¿Cuenta con gradas?</label>
                            ...
                            <?php
                            if(isset($info['gradasCanchaStatus'])){

                                if($info['gradasCanchaStatus']==0){

                                    echo '<script>document.getElementById("gradas-no").checked = true;</script>';

                                }else{
                                    echo '<script>document.getElementById("gradas-si").checked = true;</script>';
                    ...
                    <li>
                        <label for="banos">¿Hay baños?</label>
                            ...
                            <?php
                            if(isset($info['banosCanchasStatus'])){
                                
                                if($info['banosCanchasStatus']==0){

                                    echo '<script>document.getElementById("banos-no").checked = true;</script>';

                                }else{
                                    echo '<script>document.getElementById("banos-si").checked = true;</script>';
                    ...
                    <li>
                        <label for="mascotas">¿Cuenta con vestidores?</label>
                            ...
                            <?php
                            if(isset($info['vestidoresCanchaStatus'])){

                                if($info['vestidoresCanchaStatus']==0){

                                    echo '<script>document.getElementById("vestidores-no").checked = true;</script>';

                                }else{
                                    echo '<script>document.getElementById("vestidores-si").checked = true;</script>';
