...
<body>
    ...
    <main>
        <section>
            <h3 id="titulo">Alta de espacio deportivo</h3>
            <form action="#" method="post" name="alta-espacio">
                <ul>
                    ...
                    <li>
                        ...
                        <select name="alcaldia" id="alcaldia" list="alcaldia-opciones">
                    ...
                    <li>
                        ...
                        <input type="number" name="codigo-postal" id="codigo-postal" />
                    </li>
                    <li>
                    ...
                    <li>
                        <label for="mascotas">Baños:</label>
                        <label for="vig-si"><input type="radio" name="banos" value="1" id="vig-si">Si</label>
                        <label for="vig-no"><input type="radio" name="banos" value="0" id="vig-no">No</label>
                    </li>
                    <!--<li>
                    ...
                    <li>-->
                        ...
                        <div class="div-vigilancia">
                            ...
                            <label for="vigilancia-tipo0"><input type="checkbox" name="vigilancia" value="Sin seguridad"
                                ...
                                seguridad</label>-->
                    <li>
                        <label for="mascotas">Vigilancia:</label>
    ...
    if (isset($_POST["alta"])) {
        $nombre = $_POST["nombre"];
        $ubi = $_POST["ubicacion"];
        $direc = $_POST["calle"] . "," . $_POST["numero"] . "," . $_POST["colonia"] . "," . $_POST["alcaldia"] . "," . $_POST["codigo-postal"];
